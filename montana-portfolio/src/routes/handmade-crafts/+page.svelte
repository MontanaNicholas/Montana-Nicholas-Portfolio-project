<script>
  ...
  <div class="body-container">
    <div class="grid-gallery">
      {#each [
        'blueberry', 'cherry', 'chili', 'lemon', 'donut', 'croissant', 'waffle', 'hotdog',
        'lilypadp', 'choc-cake', 'lilypadw', 'candycane', 'orange', 'pumpkin', 'cake'
      ] as image}
        <div class="card">
          <img src="{base}/{image}.jpg" alt={image} class="project-image" />
        </div>
      {/each}
    </div>
  </div>
